...
<body>
  ...
  <!-- Intro -->
  <section class="about-section" id="how-colour-prediction-games-work">
    <div class="container for-bg-clr">
      <div class="row">
        <div class="h1heading center">
          <h1>How Do Colour Prediction Games Really Work?</h1>
        </div>
  ...
  <!-- What are -->
  <section class="jalwa-section" id="what-are">
  ...
  <!-- Start -->
  <section class="jalwa-section" id="start">
    <div class="container content-border">
      <div class="row">
        <div class="col-12">
          <div class="all-h2-head">
  ...
  <!-- Results -->
  <section class="jalwa-section" id="results">
    <div class="container content-border">
      <div class="row">
        <div class="col-12">
          <div class="all-h2-head">
  ...
  <!-- Variations -->
  <section class="jalwa-section" id="variations">
    <div class="container content-border">
      <div class="row">
        <div class="col-12">
          <div class="all-h2-head">
  ...
  <!-- Example -->
  <section class="jalwa-section" id="example">
    <div class="container content-border">
      <div class="row">
        <div class="col-12">
          <div class="all-h2-head">
